# Generated by Powerlevel10k configuration wizard on 2022-12-20 at 22:09 -03.
...
#   todo                    # todo items (https://github.com/todotxt/todo.txt-cli)
  ...
  # prefix. The shortened directory can be tab-completed to the original. (to_first_and_last, _middle)
